...
function renderHomeTab() {
  const historyDiv = createDOMElement("div", {
    class: "content_div",
    id: "history_div",
  });
  const historyTitle = createDOMElement(
    "h2",
    { class: "history titles", id: "history_title" },
    "La nostra història"
  );
  ...
  const brasaImg = createDOMElement("img", {
    class: "brasa images",
    id: "brasa_img",
    src: `${allImages["grill.jpg"]}`,
  });
